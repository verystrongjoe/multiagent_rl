...
def zeroed_observation_torch(observation):
...
class SequentialMemory(Memory):
    def __init__(self, limit, **kwargs):
        ...
        self.actions = RingBuffer(limit)  # todo : deque is already used in RingBuffer. Why we need this class?
    ...
    def sample(self, batch_size, batch_idxs=None):
        ...
        for idx in batch_idxs:
            ...
            while len(state0) < self.window_length:
                state0.insert(0, zeroed_observation_torch(state0[0]))  # change to torch tensor
            ...
            state1 = [x.clone() for x in state0[1:]]
        ...
        # return experiences
        return state0s, actions, rewards, state1s, terminal1s
